...
* We identified, cleaned, formatted and redistributed the data that we gathered from multiple datasets in to the new database loading data in a sequence that ensures that data is loaded into relational tables accurately.
